...
<nav id="header" class="navbar navbar-inverse fixed-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            <li class="{{ (Request::is('/') ? 'active' : '') }}"><a href="{{ route('home') }}">Articles</a></li>
            <li class="{{ (Request::is('categories') ? 'active' : '') }} ? {{ (Request::is('categories/*') ? 'active' : '') }}"><a href="{{ route('categories') }}">Categories</a></li>
            @guest
